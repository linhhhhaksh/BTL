...
CREATE TABLE `tblkhachhang` (
  ...
  `loaiKH` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`tblThanhvienID`),
  CONSTRAINT `tblkhachhang_ibfk_1` FOREIGN KEY (`tblThanhvienID`) REFERENCES `tblthanhvien` (`tblThanhvienID`)
...
INSERT INTO `tblkhachhang` VALUES (4,'binh thuong'),(5,'vip'),(6,'sieu vip');
