...
CREATE TABLE `tblnhanvien` (
  ...
  `capbacnhanvien` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`tblThanhvienID`),
  CONSTRAINT `tblnhanvien_ibfk_1` FOREIGN KEY (`tblThanhvienID`) REFERENCES `tblthanhvien` (`tblThanhvienID`)
...
INSERT INTO `tblnhanvien` VALUES (1,'QL'),(2,'LT'),(3,'NVK');
